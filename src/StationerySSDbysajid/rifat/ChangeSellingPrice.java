 ...
 * @author ASUS
 */
public class ChangeSellingPrice extends javax.swing.JFrame {

    /**
     * Creates new form ChangeSellingPrice
     */
    ...
    String [] NameArray;
                ...
                int i=0;
                String Name;
    public ChangeSellingPrice(String name) {
        initComponents();
        ...
        r.ReadProducts(Path);
                ...
                if(l==0){
                    ...
                    oldPrice.setText(String.valueOf(SPriceArray[i]));
                }
    }
    ...
    private void initComponents() {
        ...
        setTitle("StationerySSD_ChangeSellPrice");
        ...
        jLabel8.setText("Product Selling Price");
        ...
        jLabel10.setText("Current Product Selling Price :");

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 153, 51));
        jLabel11.setText("New Product Selling Price      :");
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        ...
        try{
            ...
            if(price<sprice){
                JOptionPane.showMessageDialog(null,"Selling Price is Less Than Buyuing Price");
            }
            editPrd e = new editPrd();
            e.edit(Path, Name, Name, QtyArray[i], sprice, price);
            JOptionPane.showMessageDialog(null,"Selling Price Changed");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeSellingPrice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangeSellingPrice("Not Set").setVisible(true);
            }
        });
    }
